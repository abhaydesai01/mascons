  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="mb-4">
        ...
        <a href="https://Mascons.in" className="text-blue-600">
          https://Mascons.in
        </a>{" "}
        and any related services provided by Mascons.
      </p>
      ...
      <p className="mb-4">
        ...
        using any other services provided by Mascons.
      </p>

      <p className="mb-4">
        We, Mascons, reserve the right to review and amend any of these Terms of
        ...
        the date of publication. These Terms of Service were last updated on
        June 24, 2024.
      </p>

      <h2 className="text-2xl font-semibold mb-2">Limitations of Use</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        owned by or licensed to Mascons and are protected by applicable
      ...
      <p className="mb-4">
        ...
        restrictions or the Terms of Service, and may be terminated by Mascons
        at any time.
      </p>
      ...
      <p className="mb-4">
        ...
        basis. To the extent permitted by law, Mascons makes no warranties,
      ...
      <p className="mb-4">
        In no event shall Mascons or its suppliers be liable for any
        ...
        on this website, even if Mascons or an authorised representative has
        been notified, orally or in writing, of the possibility of such damage.
      </p>

      <h2 className="text-2xl font-semibold mb-2">Accuracy of Materials</h2>
      <p className="mb-4">
        The materials appearing on our website are not comprehensive and are for
        general information purposes only. Mascons does not warrant or make any
        representations concerning the accuracy, likely results, or reliability
        of the use of the materials on this website, or otherwise relating to
        such materials or on any resources linked to this website.
      </p>

      <h2 className="text-2xl font-semibold mb-2">Links</h2>
      <p className="mb-4">
        Mascons has not reviewed all of the sites linked to its website and is
        not responsible for the contents of any such linked site. The inclusion
        of any link does not imply endorsement, approval, or control by Mascons
      ...
      <h2 className="text-2xl font-semibold mb-2">Right to Terminate</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">Severance</h2>
      <p className="mb-4">
