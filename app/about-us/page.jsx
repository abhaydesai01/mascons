...
const founders = [
  ...
  },
  {
    ...
    title: "Co-Founder",
    image: "/pankaj.png",
    bio: `An MBA Grad. from James Cook University with 15+ years of experience in fintech, driving innovation and growth across the industry. Founded and scaled two fintech startups to strategic exits, excelling in product development and sales. Extensive network with leading banks and large-scale fintech clients, recognized as a trusted expert. Honored among the Top 50 Most Influential Payment Professionals, with awards including Red Herring Top 100 Asia and Startup of the Year 2018.`,
  },
];
      ...
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center">
        <div className="lg:ml-24 flex flex-col justify-center items-center lg:items-start gap-y-4 h-auto my-8 lg:my-0 md:h-screen">
          ...
          <h1 className="text-4xl lg:text-5xl text-center lg:text-left uppercase text-gray-950 font-bold tracking-wider">
            We change the way <br /> you do money
          </h1>
